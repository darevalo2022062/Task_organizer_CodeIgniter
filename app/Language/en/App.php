...
return [
    ...
    'dashboard' => [
        ...
        'teacher' => [
            ...
            'tasks_to_grade' => 'Tasks to Grade',
            'avg_course_rating' => 'Average Rating',
        ],
        ...
        'activity' => [
            'completed_task' => 'You completed task "PHP Introduction"',
            'joined_course' => 'You joined course "Advanced Mathematics"',
            'new_message' => 'You have a new message from teacher',
        ],
    ],
    'common' => [
        'view' => 'View Details',
